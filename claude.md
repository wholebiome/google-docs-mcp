...
FastMCP server with 95 tools for Google Docs, Sheets, Drive, Gmail, and Calendar.
...
| Gmail         | 14    | `listMessages`, `getMessage`, `getAttachment`, `sendEmail`, `trashMessage`, `modifyMessageLabels`, `listLabels`, `createDraft`, `listDrafts`, `getDraft`, `updateDraft`, `sendDraft`, `deleteDraft`, `triageInbox`                                                                                                                                                                                                                                                                                     |
...
- **Gmail attachments:** `getMessage` exposes attachment metadata; use `getAttachment` with the returned `messageId` and `attachmentId` to retrieve bytes.
